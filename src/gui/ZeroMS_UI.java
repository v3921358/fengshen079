/**
 * Restore By Windyboy 2020/08/14 00:57
 */
package gui;
   ...
   /*         boolean result1 = this.a1.getText().matches("[0-9]+");
            ...
            for (ChannelServer cserv1 : ChannelServer.getAllInstances()) {
				...
				if (装备星星 > 0 && 装备星星 < 127) {
				    item.setEnhance((byte) (装备星星));
                                ...
                                MapleInventoryManipulator.addById(mch.getClient(), 物品ID, (short) 1, "", null, 给予时间,false, "");
    ...
    private void 开启三倍金币ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_开启三倍金币ActionPerformed
        ...
        if (result1) {
            ...
            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(6, "[倍率活动] : 游戏开始 3 倍打怪金币活动，将持续 " + hours + " 小时，请各位玩家狂欢吧！"));
    ...
    private void 开启三倍爆率ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_开启三倍爆率ActionPerformed
        ...
        if (result1) {
            ...
            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(6, "[倍率活动] : 游戏开始 3 倍打怪爆率活动，将持续 " + hours + " 小时，请各位玩家狂欢吧！"));
    ...
    private void 开启三倍经验ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_开启三倍经验ActionPerformed
        ...
        if (result1) {
            ...
            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(6, "[倍率活动] : 游戏开始 3 倍打怪经验活动，将持续 " + hours + " 小时，请各位玩家狂欢吧！"));
    ...
    private void 开启双倍金币ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_开启双倍金币ActionPerformed
        ...
        if (result1) {
            ...
            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(6, "[倍率活动] : 游戏开始 2 倍打怪金币活动，将持续 " + hours + " 小时，请各位玩家狂欢吧！"));
    ...
    private void 开启双倍爆率ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_开启双倍爆率ActionPerformed
        ...
        if (result1) {
            ...
            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(6, "[倍率活动] : 游戏开始 2 倍打怪爆率活动，将持续 " + hours + " 小时，请各位玩家狂欢吧！"));
    ...
    private void 开启双倍经验ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_开启双倍经验ActionPerformed
        ...
        if (result1) {
            ...
            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(6, "[倍率活动] : 游戏开始 2 倍打怪经验活动，将持续 " + hours + " 小时，请各位玩家狂欢吧！"));
            ...
            for (ChannelServer cserv1 : ChannelServer.getAllInstances()) {
                for (MapleCharacter mch : cserv1.getPlayerStorage().getAllCharacters()) {
                    switch (a) {
                        case 0:
                            //红色提示公告
                            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(5, str.toString()));
                            break;
                        case 1:
                            //顶端公告
                        ...
                        case 2:
                            //弹窗公告
                            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(1, str.toString()));
                            break;
                        case 3:
                            //聊天蓝色公告
                            World.Broadcast.broadcastMessage(CWvsContext.serverNotice(0, str));
                            break;
                        case 4:
